!(function (e) {
  ...
  function (e, t, r) {
    function n(e, t, r) {
      ...
      var n = typeof t;
      return (
        !!("number" == n ? i(r) && s(t, r.length) : "string" == n && t in r) &&
        o(r[t], e)
      );
    }
    var o = r(6),
  ...
  function (e, t, r) {
    function n(e) {
      ...
      return (
        t == u ||
        t == a ||
        ("string" == typeof e.message && "string" == typeof e.name && !s(e))
      );
    }
    var o = r(0),
      i = r(1),
        ...
        for (
          ...
          for (var b = 0; b < u; b++) {
            ...
            if (null !== (a = f ? c.geometries[b] : c)) {
              ...
              var x = a.type;
              switch (
                ((p = !r || ("Polygon" !== x && "MultiPolygon" !== x) ? 0 : 1),
                x)
              ) {
                case null:
                  break;
    ...
    function s(e, t) {
      o(e, function (e, r, n, o, i) {
        ...
        switch (s) {
          ...
          case "LineString":
          case "Polygon":
            if (!1 === t(Object(l.b)(e, n, { bbox: o, id: i }), r, 0))
              return !1;
            return;
        }
        var a;
        ...
        if ((this._finishMeasure(), e.length)) {
          ...
          i &&
            ...
            L.DomEvent.on(
              ...
              function () {
                t.getBounds
                  ? this._map.fitBounds(t.getBounds(), {
                      padding: [20, 20],
                      maxZoom: 17,
                    })
  ...
  function (e, t, r) {
    function n(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, s = -1, a = i(n.length - t, 0), u = Array(a);
            ++s < a;
    ...
    function n(e, t, r) {
      ...
      var n = r.units,
        ...
        p =
          ...
          Math.pow(Math.sin(l / 2), 2) * Math.cos(c) * Math.cos(f);
